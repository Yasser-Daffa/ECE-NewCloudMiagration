# Form implementation generated from reading ui file 'view_prereqs.ui'
#
...
class Ui_ViewPrereqs(object):
    def setupUi(self, ViewPrereqs):
        ViewPrereqs.setObjectName("ViewPrereqs")
        ViewPrereqs.resize(1200, 858)
        ViewPrereqs.setStyleSheet("background-color: #f5f7fa;")
        self.mainLayout = QtWidgets.QVBoxLayout(ViewPrereqs)
        self.mainLayout.setContentsMargins(40, 40, 40, 20)
        self.mainLayout.setSpacing(30)
        self.mainLayout.setObjectName("mainLayout")
        self.headerLayout = QtWidgets.QHBoxLayout()
        self.headerLayout.setObjectName("headerLayout")
        self.labelTitle = QtWidgets.QLabel(parent=ViewPrereqs)
        ...
        self.labelTotalCoursesCount = QtWidgets.QLabel(parent=ViewPrereqs)
...
"")
        ...
        self.filterFrame = QtWidgets.QFrame(parent=ViewPrereqs)
...
"}")
        ...
        self.tableFrame = QtWidgets.QFrame(parent=ViewPrereqs)
...
"")
        ...
        self.retranslateUi(ViewPrereqs)
        QtCore.QMetaObject.connectSlotsByName(ViewPrereqs)

    def retranslateUi(self, ViewPrereqs):
        _translate = QtCore.QCoreApplication.translate
        ViewPrereqs.setWindowTitle(_translate("ViewPrereqs", "Course"))
        self.labelTitle.setText(_translate("ViewPrereqs", "Course Prerequisites"))
        self.labelTotalCoursesCount.setText(_translate("ViewPrereqs", "22 Total Courses"))
        self.lineEditSearch.setPlaceholderText(_translate("ViewPrereqs", "🔍  Search by Course name or code..."))
        self.buttonRefresh.setText(_translate("ViewPrereqs", "🔄 Refresh"))
        self.tableTitle.setText(_translate("ViewPrereqs", "All Courses"))
        item = self.tableAllCourses.horizontalHeaderItem(0)
        item.setText(_translate("ViewPrereqs", "SELECT"))
        item = self.tableAllCourses.horizontalHeaderItem(1)
        item.setText(_translate("ViewPrereqs", "#"))
        item = self.tableAllCourses.horizontalHeaderItem(2)
        item.setText(_translate("ViewPrereqs", "COURSE CODE"))
        item = self.tableAllCourses.horizontalHeaderItem(3)
        item.setText(_translate("ViewPrereqs", "COURSE NAME"))
        item = self.tableAllCourses.horizontalHeaderItem(4)
        item.setText(_translate("ViewPrereqs", "PREREQ"))
