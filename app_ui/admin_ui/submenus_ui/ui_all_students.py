...
"")
    ...
    def retranslateUi(self, AllStudents):
        ...
        self.comboBoxSelectProgram.setItemText(0, _translate("AllStudents", "All Programs"))
        self.comboBoxSelectProgram.setItemText(1, _translate("AllStudents", "Computer"))
        self.comboBoxSelectProgram.setItemText(2, _translate("AllStudents", "Communication"))
        self.comboBoxSelectProgram.setItemText(3, _translate("AllStudents", "Power"))
        self.comboBoxSelectProgram.setItemText(4, _translate("AllStudents", "Biomedical"))
