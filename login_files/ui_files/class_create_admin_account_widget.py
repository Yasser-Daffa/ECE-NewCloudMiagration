...
from login_files.ui_files.raw_ui.ui_create_admin_account_widget import Ui_CreateAdminAccountWidget
import login_files.login_resources_rc



class CreateAdminAccountWidget(BaseLoginForm):
    """
    Admin account creation widget.
    Uses BaseLoginForm for:
    - Shadows
    - Password toggles
    ...
    def __init__(self):
        super().__init__()
        self.ui = Ui_CreateAdminAccountWidget()
...
if __name__ == "__main__":
    ...
    window = CreateAdminAccountWidget() 
    window.show()
    sys.exit(app.exec())
