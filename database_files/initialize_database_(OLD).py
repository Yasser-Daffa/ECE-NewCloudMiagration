# initialize_database.py  (PostgreSQL Version)
# RAILWAY IS REAAAALLLLLYYYY SLOWWWWWWWWWWWW IT KEEPS CRASHING THE PROGRAM
# AND TAKES 40++ SECONDS TO LOAD FOR THE FIRST TIME
import psycopg2

def initialize_database():
    """Initializes all PostgreSQL tables, triggers, and constraints."""
